...
export default function ClienteNaturalLista({ navigate }: ClienteNaturalListaProps) {
  ...
  const clientesFiltrados = clientes.filter(c => {
    if (c.tipoCliente !== 'NATURAL') return false;
  ...
  return (
    <div className="p-8 bg-[#F5F7FA] min-h-full">
      <div className="mb-8">
        <h1 className="text-3xl font-semibold text-[#0D1B4B] mb-2">Clientes Naturales</h1>
        <p className="text-gray-600">Gestión de personas naturales del banco</p>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                <th className="text-left py-3 px-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Cédula/Pasaporte</th>
                <th className="text-left py-3 px-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Nombres</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {loading ? (
                <tr>
                  <td colSpan={4} className="text-center py-10 text-gray-400 text-sm">Cargando clientes...</td>
                </tr>
              ) : clientesPagina.length === 0 ? (
                <tr>
                  <td colSpan={4} className="text-center py-10 text-gray-400 text-sm">No se encontraron clientes naturales</td>
                </tr>
              ) : (
